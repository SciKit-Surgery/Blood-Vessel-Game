...
window.onload = function() {
    let gameConfig = {
        ...
        physics: {
            ...
            matter: {
                gravity: {
                    y: 0 // changing this to great than - will make the shape drop
                },
                debug: true,
            }
        }
...
class playGame extends Phaser.Scene{
    ...
    create(){
        ...
        this.matter.world.setBounds(10, 10, game.config.width - 20, game.config.height - 10);
        this.matter.add.rectangle(game.config.width / 3 - 10, game.config.width / 5, 600, 100); // 2 = how high up the artery starts to fall
