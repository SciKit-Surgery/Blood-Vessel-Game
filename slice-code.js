...
window.onload = function() {
    ...
    slice-code = new Phaser.Game(gameConfig);
    window.focus();
}
class playGame extends Phaser.Scene{
    ...
    create(){
        ...
        this.matter.world.setBounds(10, 10, slice-code.config.width - 20, slice-code.config.height - 20);
        this.matter.add.rectangle(slice-code.config.width / 2 - 50, slice-code.config.width / 2, 100, 300);
